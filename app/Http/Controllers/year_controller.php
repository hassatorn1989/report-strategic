...
class year_controller extends Controller
{
    ...
    {
        // dd(view_year_strategic::with('get_year_strategic_detail')->get());
        $year = tbl_year::find($request->id);
    ...
    {
        $q = view_year_strategic::with('get_year_strategic_detail');
        return DataTables::eloquent($q)
            ->filter(function ($q) use ($request) {
                if ($request->filter_year_name != '') {
                    $q->whereRaw("year_name like '%{$request->filter_year_name}%'");
    ...
    {
        $q = view_year_strategic::with('get_year_strategic_detail')->find($request->id);
        return response()->json($q);
    }
