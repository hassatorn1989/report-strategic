                                ...
                                <div class="row mt-3">
                                    <div class="col-7 col-sm-12">
                                        <ul class="nav nav-tabs mb-3" id="custom-content-below-tab" role="tablist">
                                            ...
                                            @endif
                                            <li class="nav-item">
                                                <a class="nav-link active" id="vert-tabs-project-main-tab"
                                                    data-toggle="pill" href="#vert-tabs-project-main" role="tab"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="vert-tabs-project-target-group-tab"
                                                    data-toggle="pill" href="#vert-tabs-project-target-group"
                                                    role="tab" aria-controls="vert-tabs-project-target-group"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="vert-tabs-project-quantitative-indicators-tab"
                                                    ...
                                                    role="tab"
                                                    aria-controls="vert-tabs-project-quantitative-indicators"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="vert-tabs-project-qualitative-indicators-tab"
                                                    ...
                                                    role="tab"
                                                    aria-controls="vert-tabs-project-qualitative-indicators"
                                        ...
                                        <div class="tab-content" id="vert-tabs-tabContent">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <select class="custom-select"
                                                                        name="project_responsible_person_position"
                                                                        id="project_responsible_person_position">
                                                                        <option value="">
                                                                            {{ __('msg.select_project_responsible_person_position') }}
                                                                        </option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                @if ($project->project_status == 'draff' || $project->project_status == 'reject')
                                                                    <div style="text-align: center;">
                                                                        <a href="#"
                                                                            onclick="add_data_project_problem()"
                                                                            data-toggle="modal"
                                            ...
                                            <div class="tab-pane fade" id="vert-tabs-project-qualitative-indicators"
                                                ...
                                                @if ($project->project_status == 'draff' || $project->project_status == 'reject')
                                                    <form
                                                        action="{{ route('project.manage.qualitative-indicators-store') }}"
                                            ...
                                            <div class="tab-pane fade" id="vert-tabs-project-impact" role="tabpanel"
                                                ...
                                                @if ($project->project_status == 'draff' || $project->project_status == 'reject')
                                                    <form action="{{ route('project.manage.impact-store') }}"
                                                        method="post" id="form-project-impact">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-10">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-4 offset-md-8">
                                                            <button type="button" class="btn btn-primary btn-block"
                                                                ...
                                                                onclick="add_project_file()">{{ __('msg.btn_add') }}</button>
                                                        </div>
                                                    </div>
                                                @endif
                                                    ...
                                                    <tbody>
                                                        @if (count($project->get_project_file) > 0)
                                                            @foreach ($project->get_project_file as $key => $item)
                                                                <tr>
                                                                    <td scope="row">{{ $key + 1 }}</td>
                                                                    <td><a href="{{ url('storage/app/' . $item->project_file_path) }}"
                                                                            target="_blank">{{ $item->project_file_name }}</a>
                                                                    </td>
                                                                    <td>
                                                                        @if ($project->project_status == 'draff' || $project->project_status == 'reject')
                                                                            <button
...
@section('modal')
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio"
                                            id="indicators_outcome_type" name="indicators_outcome_type"
                                            value="quantitative">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio"
                                            id="indicators_outcome_type2" name="indicators_outcome_type"
                                            value="qualitative">
    ...
    <div class="modal fade" id="modal-file" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <form action="{{ route('project.manage.file-store') }}" method="post" id="form-project-file"
