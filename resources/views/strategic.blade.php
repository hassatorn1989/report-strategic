...
@section('title', __('msg.menu_setting_strategic'))
@push('css')
@endpush
...
@push('script')
    <script>
        var lang = {
            title_add : '{{ __('msg.title_add_strategic') }}',
            title_edit : '{{ __('msg.title_edit_strategic') }}',
        };
    </script>
    <script src="{{ url('resources/assets') }}/app/strategic.js?q={{ time() }}"></script>
@endpush
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('msg.menu_setting_strategic') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('dashboard.index') }}">{{ __('msg.menu_dashboard') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('msg.menu_setting_strategic') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-list"></i>
                                    {{ __('msg.msg_list') . __('msg.menu_setting_strategic') }}</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="search" class="form-control" name="filter_strategic_name"
                                                    id="filter_strategic_name" placeholder="{{ __('msg.filter_strategic_name') }}"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                ...
                                <table id="example1" class="table table-hover table-sm table-striped">
                                    <thead class="thead-light">
                                        <tr>
                                            <th width="5%">#</th>
                                            <th width="70%">{{ __('msg.strategic_name') }}</th>
